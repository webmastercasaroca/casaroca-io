...
(function () {
  ...
  /* ------------------------------------------------------------
     ...
     ------------------------------------------------------------ */
  const GRUPOS = [
    { afId: "af_j25_cafe", liderId: "li_daniel", lider: "Daniel Garzón", liderTel: "+57 310 555 0142", liderEmail: "lider.demo@example.org", liveStore: true },
  ...
  const LIDERES = [
    { id: "li_daniel", nombre: "Daniel Garzón", tel: "+57 310 555 0142", email: "lider.demo@example.org" },
