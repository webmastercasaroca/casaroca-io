...
(function () {
  ...
  // Los iframes de consejería usan rutas RELATIVAS (ver `paginas`), que es lo
  // que permite que el panel anidado funcione con los archivos co-desplegados
  // en este mismo sitio. La constante que apuntaba a consejeriacr.netlify.app
  // era código muerto: se declaraba y no se usaba nunca. Se elimina para que
  // nadie la reviva apuntando al despliegue antiguo.
